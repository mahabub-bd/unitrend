...
function LabelPrintingInkMachine() {
    return (
        <div>
            <CTable striped hover responsive="sm" align="middle">
                <CTableHead>
                    <CTableRow>
                ...
                <CTableBody>
                    {data.labelprintingmachine.map((item) => (
                        <CTableRow>
...
export default LabelPrintingInkMachine;
